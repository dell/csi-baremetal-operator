...
func (r *DeploymentReconciler) SetupWithManager(ctx context.Context, mgr ctrl.Manager) error {
	...
	err = c.Watch(source.Kind(mgr.GetCache(), &appsv1.DaemonSet{}), handler.EnqueueRequestForOwner(
		mgr.GetScheme(),
		mgr.GetRESTMapper(),
		&csibaremetalv1.Deployment{},
		handler.OnlyControllerOwner()),
	...
	err = c.Watch(source.Kind(mgr.GetCache(), &corev1.Pod{}), handler.EnqueueRequestsFromMapFunc(func(ctx context.Context, obj client.Object) []reconcile.Request {
		var (
	...
	err = c.Watch(source.Kind(mgr.GetCache(), &corev1.Node{}), handler.EnqueueRequestsFromMapFunc(func(ctx context.Context, obj client.Object) []reconcile.Request {
		var (
			deployments = &csibaremetalv1.DeploymentList{}
			node        *corev1.Node
			ok          bool
...
func watchRole(c controller.Controller, cl client.Client, m rbac.Matcher,
	...
	log *logrus.Entry, mgr ctrl.Manager,
) error {
	return c.Watch(source.Kind(mgr.GetCache(), &rbacv1.Role{}), handler.EnqueueRequestsFromMapFunc(func(ctx context.Context, obj client.Object) []reconcile.Request {
		var (
			deployments = &csibaremetalv1.DeploymentList{}
			role        = &rbacv1.Role{}
			ok          bool
...
func watchRoleBinding(c controller.Controller, cl client.Client, m rbac.Matcher, log *logrus.Entry, mgr ctrl.Manager) error {
	return c.Watch(source.Kind(mgr.GetCache(), &rbacv1.RoleBinding{}), handler.EnqueueRequestsFromMapFunc(func(ctx context.Context, obj client.Object) []reconcile.Request {
		var (
			deployments = &csibaremetalv1.DeploymentList{}
